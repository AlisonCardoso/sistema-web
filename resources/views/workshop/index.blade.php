                    ...
                    <table class="divide-y divide-green-400 ">
                      <thead class="bg-gray-50">
                        <tr>
                          <th class="px-6 py-2 text-xs text-gray-500">ESTADO</th>
                           ...
                           <th class="px-6 py-2 text-xs text-gray-500">Nome Fantasia</</th>
                           <th class="px-6 py-2 text-xs text-gray-500">NOME</th>
                      ...
                      <tbody class="bg-white divide-y divide-gray-400">
                        ...
                        <tr class="whitespace-nowrap">
                          ...
                          <td class="px-6 py-4 text-sm text-gray-700">{{$workshop->nome_fantasia}}</td>
                          <td class="px-6 py-4 text-sm text-gray-700">{{$workshop->name}}</td>
                          <td class="px-6 py-4 text-sm text-gray-700">{{$workshop->email}}</td>
                          ...
                          <td class="px-6 py-4">
                            <a href="vehicles.edit"> <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
